...
async function main() {
    ...
    // Load the cargo container splat file (relative to index.html)
    const response = await fetch("./Cargo_Container_cutted.splat");
    if (!response.ok) {
        throw new Error("Unable to load Cargo_Container_cutted.splat");
    }
